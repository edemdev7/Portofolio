    ...
    >
      <div class="flex flex-col md:flex-row items-center h-full pt-8">
        <div class="flex-1 flex flex-col items-center lg:items-start">
          <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Edem! 👋</p>
            ...
            <div class="flex items-center mb-6">
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://facebook.com/casimiredem.madetinkpomachi.9"
              >
                <svg
                  width="8"
                  height="16"
              ...
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://twitter.com/se_connecter"
              >
                <svg
                  width="16"
                  height="12"
              ...
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://www.linkedin.com/in/edem-kpomachi-7b2189264/"
              >
                <svg
                  width="14"
                  height="14"
